...
from app.handlers.contentAdmin import AdminOperations
...
def admin_users():
    ...
    match method:
        ...
        case 'delete':
            pass
    return render_template('admin/users.html', static_content=static_content)
...
def admin_appointments():
    ...
    return render_template('admin/appointments.html', static_content=static_content)
...
def admin_masters():
    ...
    return render_template('admin/masters.html', static_content=static_content)
...
def admin_general():
    ...
    return render_template('admin/general.html', static_content=static_content)
...
def admin_services():
    ...
    return render_template('admin/services.html', static_content=static_content)
...
def admin():
    ...
    panel_page = request.values.get('panel_page ')

    if request.method == 'POST':

        form_data = request.form

        match form_data.get('button_insert'):

            case 'appointment':
                AdminOperations.insert(
                    Appointments,
                    form_data
                )
        ...
        match form_data.get('button_update'):
